...
Testo удобен для AI-агентов — и при написании новых тестов, и при миграции с других фреймворков. Загляните сначала на страницу [AI-агенты](./ai-agents.md), и большую часть шагов ниже агент сделает за вас.
:::
