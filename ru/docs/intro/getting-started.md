...
::: tip Работаете с AI-ассистентом?
Testo удобен для AI-агентов — и при написании новых тестов, и при миграции с PHPUnit, Pest или Codeception. Загляните сначала на страницу [AI-агенты](./ai-agents.md), и большую часть шагов ниже агент сделает за вас.
:::
