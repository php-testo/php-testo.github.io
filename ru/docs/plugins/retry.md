...
Retry прощает одно случайное падение и останавливается, как только тест прошёл. Если же задача обратная — доказать, что тест стабилен, прогнав его N раз подряд независимо от первого результата — используйте <attr>\Testo\Repeat</attr>. В описании [плагина Repeat](./repeat.md#repeat-ili-retry) есть таблица сравнения и правила одновременного использования обоих атрибутов.
