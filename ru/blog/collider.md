...
Давайте в этом убедимся: напишем функции и добавим атрибут <attr>\Testo\Bench</attr> на одну из функций.
...
С помощью атрибута <attr>\Testo\Bench</attr> мы говорим Testo, что:
...
В атрибуте <attr>\Testo\Bench</attr> есть параметр `iterations`, который и отвечает за количество перезапусков бенчмарков.
