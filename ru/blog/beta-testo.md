...
Да. Testo предоставляет `llms.txt` и `llms-full.txt` — специальные файлы для AI-агентов с описанием API фреймворка. Скормите их вашему агенту, и он сразу начнёт писать тесты на Testo. Подробнее — в [документации](/ru/docs/guide/ai-agents.md).
:::
